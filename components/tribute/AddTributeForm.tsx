...
export default function AddTributeForm({ onClose }: AddTributeFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-xl w-full max-w-full relative">
      {/* Sticky Header with Close Button - Always visible on scroll */}
      <div className="sticky top-0 bg-white z-10 border-b border-gray-200 px-6 pt-6 pb-4 md:px-8">
