...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { href: '/tuong-nho', label: 'Tưởng nhớ' },
    { href: '#add-tribute', label: 'Góp kỷ niệm', isButton: true },
  ];
        ...
        <div className="flex items-center justify-between md:justify-center h-20">
          ...
          <div className="hidden md:flex items-center gap-5 lg:gap-6">
            {navItems.map((item) => {
              ...
              // Button style for "Lưu kỷ niệm" - Use native <a> for hash navigation
              if (item.isButton) {
                return (
                  <a
                    key={item.href}
          ...
          {/* Mobile: Góp Kỷ Niệm Button - Right Aligned */}
          <a
            href="#add-tribute"
